          ...
          <!-- 个人资料显示与修改 -->
            ...
            <el-form label-position="right" label-width="80px" :model="formLabelAlign">
              <el-form-item label="姓名" prop="user_name">
                <el-input v-model="formLabelAlign.name_name" readonly="" id="in_name" type="text" @blur="checkname" :placeholder="this.myname"></el-input>
              </el-form-item>

              <el-form-item label="性别" prop="sex" >
              <el-select v-model="formLabelAlign.user_sex" :placeholder="this.usex">
            ...
            <el-form-item label="借阅ID" prop="id">
              <el-input v-model="formLabelAlign.borrowID" readonly="" :placeholder="this.uid" ></el-input>
            </el-form-item>

            <el-form-item label="邮箱" prop="email">
              <el-input v-model="formLabelAlign.user_email" readonly="" id="in_email" @blur="checkemai" :placeholder="this.uemail" class="in"></el-input>
              <span id="ec" style="font-size:5px;color: red"></span>
            </el-form-item>

            <el-form-item label="年龄" prop="age">
              <el-input v-model="formLabelAlign.user_age" readonly="" :placeholder="this.uage" id="age" class="in"></el-input>
            </el-form-item>

            <el-form-item label="出生年月" prop="birth">
              <el-date-picker
                v-model="formLabelAlign.user_birthday"
                type="date"
            ...
            <el-form-item label="联系电话" prop="tel">
              <el-input v-model="formLabelAlign.user_phone" readonly="" :placeholder="this.uphone"  class="in" id="phone"></el-input>
            </el-form-item>

            <el-form-item label="居住地址" prop="address">
              <el-input v-model="formLabelAlign.user_address" readonly="" :placeholder="this.uaddress"  class="in" id="address"></el-input>
            </el-form-item>
...
<!--              </el-form-item><br/>-->
<!--&lt;!&ndash;              <el-form-item label="个人描述" prop="desc">&ndash;&gt;-->
<!--&lt;!&ndash;                <el-input type="textarea" v-model="formInline.desc" :rows="3" style="width: 720px" readonly="" resize:none id="txt"  class="in"></el-input>&ndash;&gt;-->
    ...
    created() {
      ...
      methods: {
        ...
        show() {
          ...
          var user_sex = this. formLabelAlign.user_sex
          var user_birthday = this. formLabelAlign.user_birthday
          var user_email = this. formLabelAlign.user_email
          var user_age = this. formLabelAlign.user_age
          var id = this. formLabelAlign.id
          var user_phone = this. formLabelAlign.user_phone
          var user_address = this. formLabelAlign.user_address
