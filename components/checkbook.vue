      ...
      <el-header>
        <div class="nav">
          <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <span style="color: red;margin-left: 200px;float: left"><h3>用户名：{{myname}}</h3></span>
...
<!--详情页面-->
          <div>
          <div class="detail2" id="de" v-show="showde" style="margin-left: 300px;width: 1000px">
            <el-table
              :data="bookData"
              style="width: 100%"
            ...
            <el-table
              ...
              <el-table-column label="详情">
                <template slot-scope="scope">
                  ...
                  <el-button slot="reference" @click="borrow(scope.row.book_name)" id="bo" >{{bz}}</el-button>
                </template>
              </el-table-column>
            </el-table>
          </div>
